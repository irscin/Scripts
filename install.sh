...
if [ -e $script ];
	then
		...
		wget "https://raw.githubusercontent.com/irscin/Scripts/master/SafeShutdown.py"
fi
#-----------------------------------------------------------
...
echo "RetroFlag Pi Case installation done. Will now install updates"
sleep 3
#-----------------------------------------------------------
#Step 8) Installing updates
sudo apt update
sudo apt upgrade
#Step 9) Enabling SSH
